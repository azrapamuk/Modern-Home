...
namespace ModernHome.Controllers
{
    public class KorpaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ukupanIznos,Idkorisnik")] Korpa korpa)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ukupanIznos,Idkorisnik")] Korpa korpa)
        {
            if (id != korpa.Id)
            {
                return NotFound();
